...
sample_playlist2_id = ObjectId('5d55cffc4a3d4031f42827a4')
sample_playlist2 = {
    'title': 'Cat Videos',
    'description': 'Cats acting weird',
    'videos': [
...
class PlaylistsTests(TestCase):
    ...
    def test_update_playlist(self, mock_update):
        result = self.client.post(f'/playlists/{sample_playlist2_id}', data=sample_form_data)
        self.assertEqual(result.status, '302 FOUND')
        mock_update.assert_called_with({'_id': sample_playlist2_id}, {'$set': sample_playlist2})
